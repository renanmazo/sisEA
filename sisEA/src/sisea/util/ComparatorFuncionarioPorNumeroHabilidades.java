...
public class ComparatorFuncionarioPorNumeroHabilidades implements Comparator<Funcionario>{
	...
	public List<Funcionario> ordenaPorNumeroHabilidades(List<Funcionario> lista){
